...
function ToBronzeRewardsDonut(props) {
  ...
  const textCenter = {
    ...
    afterDatasetsDraw(chart) {
      ...
      ctx.fillStyle = '#B59B82';
      ctx.textAlign = 'center';
      ctx.textBaseline = 'middle';
      ctx.fillText(`Bronze`, xCoor, yCoor + 10);
    },
  };

  return (
    <Col>
      <h4 className="header-title bolder text-center mb-3">Headed To Bronze</h4>
