...
function ToBronzeRewardsDonut(props) {
  ...
  const textCenter = {
    ...
    afterDatasetsDraw(chart) {
      ...
      ctx.fillStyle = '#B6B7B7';
      ctx.textAlign = 'center';
      ctx.textBaseline = 'middle';
      ctx.fillText(`Silver`, xCoor, yCoor + 10);
    },
  };

  return (
    <Col>
      <h4 className="header-title bolder text-center mb-3">Headed For Silver</h4>
