...
export default function TermsAndConditions() {
  return (
    <React.Fragment>
      <main className="termsandconditions-content">
        <section>
          <Row>
            <Col>
              <Card>
                <Card.Body>
                  <h1 className=" display-6 text-center">TERMS OF SERVICE</h1>
                  <h4>OVERVIEW</h4>
                  <p>
                    This website is operated by Hasty. Throughout the site, the terms “we”, “us” and “our” refer to
                    Hasty. Hasty offers this website, including all information, tools and Services available from this
                    site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and
                    notices stated here.
                  </p>
                  <p>
                    ...
                    browsers, vendors, customers, merchants, and/ or contributors of content. Please read these Terms of
                    Service carefully before accessing or using our website. By accessing or using any part of the site,
                    you agree to be bound by these Terms of Service. If you do not agree to all the terms and conditions
                    of this agreement, then you may not access the website or use any Services. If these Terms of
                    Service are considered an offer, acceptance is expressly limited to these Terms of Service.{' '}
                  </p>
                  <p>
                    If you have any questions please feel free to <a href="/contactus">Contact Us at This Link</a>
                  </p>
                  <p>
                  ...
                  <div className="clearfix"></div> <h4>SECTION 2 - GENERAL CONDITIONS</h4>
                  ...
                  <p>
                    ...
                    any warranties, representations or conditions of any kind and without any endorsement. We shall have
                  ...
                  <p>
                    ...
                    online, by email, by postal mail, or otherwise (collectively, &apos;comments&apos;), you agree that
                  ...
                  <p>
                    ...
                    our Privacy Policy, please see <a href="/privacy">[OUR PRIVACY POLICY]</a>
                  </p>
                  ...
                  <p>
                    In no case shall Hasty, our directors, officers, employees, affiliates, agents, contractors,
                  ...
                  <p>
                    You agree to indemnify, defend and hold harmless Hasty and our parent, subsidiaries, affiliates,
                  ...
                  <p>
                    ...
                    to The Service constitutes the entire agreement and understanding between you and us and govern your
                  ...
                  <p>Questions about the Terms of Service should be sent to us at hastyprojectdevelopment@gmail.com.</p>
                  <p className="mb-0">Our contact information is posted below:</p>
                  <p className="mb-0">[INSERT TRADING NAME]</p>
                  <p className="mb-0">[INSERT EMAIL ADDRESS]</p>
                  <p className="mb-0">[INSERT BUSINESS ADDRESS]</p>
                  <p className="mb-0">[INSERT BUSINESS PHONE NUMBER]</p>
                  <p className="mb-0">[INSERT BUSINESS REGISTRATION NUMBER]</p>
                  <p className="mb-0">[INSERT VAT NUMBER]</p>
